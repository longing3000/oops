...
////////////////////////////////////////////////////////////////////////////////
//{{{  SCIEnsembleCCE
void SCIEnsembleCCE::set_parameters()
{
...
vec SCIEnsembleCCE::cluster_evolution(int cce_order, int index)
{
...
Hamiltonian SCIEnsembleCCE::create_spin_hamiltonian(const cSPIN& espin, const PureState& center_spin_state, const vector<cSPIN>& spin_list)
{/*{{{*/ 
...
LiouvilleSpaceOperator SCIEnsembleCCE::create_incoherent_operator(const vector<cSPIN>& spin_list)
{/*{{{*/
...
Liouvillian SCIEnsembleCCE::create_spin_liouvillian(const Hamiltonian& hami0, const Hamiltonian hami1)
{/*{{{*/
...
DensityOperator SCIEnsembleCCE::create_spin_density_state(const vector<cSPIN>& spin_list)
{/*{{{*/
...
vec SCIEnsembleCCE::calc_observables(QuantumEvolutionAlgorithm* kernel)
{/*{{{*/
