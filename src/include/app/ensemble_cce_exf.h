...
private:
    Hamiltonian create_spin_hamiltonian(const cSPIN& espin, const PureState& center_spin_stat, const vector<cSPIN>& spin_list, const double& amplitude_list, const double& phase_list, const vec& axis, const double& omega);
